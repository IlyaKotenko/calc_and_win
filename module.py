...
def get_user_attack():
    ...
    for i in range(5):
        ...
        if input_attack not in attacks_types:
            raise ValueError('Такой команды атаки нет.')
...
def run_game():
    ...
    remaining_health = enemy_health - user_total_attack
    print(f'Тобой нанесён урон противнику равный {user_total_attack}.')
    print(f'Очки здоровья противника после твоей атаки: {remaining_health}.')
